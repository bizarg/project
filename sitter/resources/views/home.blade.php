                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="form-horizontal" role="form" method="POST" action="{{ url('admin/order') }}">
                                            {{csrf_field()}}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <select id="tariff" class="form-control" name="tariff">
                                                            <option value="Standart">Standart(15 UAH)</option>
                                                            <option value="Premium">Premium(50 UAH)</option>
                                                            <option value="Universal">Universal(Individually)</option>
                                                    </select>
                                                </div>
                                            </div>
