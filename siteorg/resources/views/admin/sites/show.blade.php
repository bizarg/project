...
@section('breadcrumb')
    ...
    <li class="active">{{ $site->domain }}</li>
@endsection
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Status <span class="pull-right">Name: {{ $user['name'] }}</span></div>
                <div class="panel-body">
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                <form id="form" action="{{ action('Admin\AdminController@change_notify') }}">
                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-md-offset-6">
                            @if( count($yandex))
                            <a href="{{ action('Admin\HistoryController@yandex_history', [$site->id]) }}" class="btn btn-default">History</a>
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-md-offset-6">
                            @if( count($site->screenshots))
                                <a href="{{ action('Admin\HistoryController@screenshots_history', [$site->id]) }}" class="btn btn-default">History</a>
                            @endif
                        </div>
                    </div>
                </div>
