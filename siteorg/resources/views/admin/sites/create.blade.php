                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('sites.store') }}">
                            ...
                            <div class="form-group{{ $errors->has('domain') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="domain" type="text" class="form-control" name="domain" value="{{ old('domain') }}" autofocus>
                            ...
                            <div class="form-group{{ $errors->has('main_url') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="main_url" type="text" class="form-control" name="main_url" value="{{ old('main_url') }}" autofocus>
