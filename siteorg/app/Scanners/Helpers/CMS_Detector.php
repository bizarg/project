...
/*
The CMS_Sniffer class can be used to detect web applications installed on the website.

Written by: Hamed Afshar
Company: Golha (http://www.golha.net)

Some of the code is derived from "Chrome Sniffer"
URL: https://chrome.google.com/extensions/detail/homgcnaoacgigpkkljjjekpignblkeae

Change Log:
	Version 1.3 (2011/09/23)
		Drupal and MyBB are now supported
	
	Version 1.2 (2011/05/12)
		Fixes on find by regex
		OpenCart fixed
		
	Version 1.1 (2011/05/12)
		Jquery, ExtJS and DatalifeEngine are supportd.
