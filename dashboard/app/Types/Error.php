...
class Error
{
    ...
    public $errors = [
        'auth.key.bad' => 'неправильный или отсутствует ключ авторизации',
        'request.empty' => 'запрос пустой',
        'request.json.error' => 'неправильная json строка',
        'domain.required' => 'домен обязательное поле',
        'domain.length.min' => 'слишком короткое имя домена',
        'domain.length.max' => 'слишком длинное имя домена',
        'domain.name.error' => 'невалидное имя домена',
        'domain.user.has' => 'домен принадлежит пользователю',
        'domain.not.confirm' => 'домен не подтвержден',
        'domain.code' => 'сайт вернул не 200 код',
        'domain.screenshot.error' => 'ошибка получения скриншота сайта',
        'info.type.not.support' => 'тип данных не поддерживается',
        'registrator.length.max' => 'слишком длинное имя регистратора',
        'domain.add.success' => 'домен добавленн пользователю',

        'domain.not.exist' => 'Домен не найден',// домен не найден

        'domain.id.required' => 'id сайта обязательное поле',
        'domain.id.not.found' => 'id сайта не найден',
        'domain.confirm.error' => 'ошибка подтверждения',
        'domain.user.error' => 'домен не добален пользователю'
