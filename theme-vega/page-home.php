        ...
        <ul class="gallery-slider">
            <?php if( have_rows('slides') ): ?>
                <?php while ( have_rows('slides') ) : the_row(); ?>
                    ...
                    <li>
                        <div class="slide-box">
                            <img src="<?php echo $img['url'];?>" alt="gallery-img01">
                            <div class="slider-description">
                                <div class="slider-description-vertical">
                                    <h3 class="underline red-underline"><?php echo $header; ?></h3>
                                    <p>
                                        <?php echo $text; ?>
                                    </p>
                                    <a href="<?php echo $link; ?>" class="btn ico-btn ico-gallery">Смотреть галерею</a>
